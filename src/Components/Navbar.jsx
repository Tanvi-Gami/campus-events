    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#020617]/80 backdrop-blur-xl border-b border-white/10 px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            to="/events"
            className={`text-sm font-bold tracking-wide transition-all hover:text-[#06B6D4] ${
              isActive("/events") ? "text-[#06B6D4]" : "text-[#CBD5E1]/70"
            }`}
          >
            EVENTS
          </Link>
          <Link
            to="/fests"
            className={`text-sm font-bold tracking-wide transition-all hover:text-[#06B6D4] ${
              location.pathname.startsWith("/fests") ? "text-[#06B6D4]" : "text-[#CBD5E1]/70"
            }`}
          >
            FESTS
          </Link>
          <Link
            to="/merch"
            className={`text-sm font-bold tracking-wide transition-all hover:text-[#06B6D4] ${
              isActive("/merch") ? "text-[#06B6D4]" : "text-[#CBD5E1]/70"
            }`}
          >
            MERCH
          </Link>
          <Link
            to="/calendar"
            className={`text-sm font-bold tracking-wide transition-all hover:text-[#06B6D4] ${
              isActive("/calendar") ? "text-[#06B6D4]" : "text-[#CBD5E1]/70"
            }`}
          >
            CALENDAR
          </Link>
          ...
          {role === "organizer" && (
            <Link
              ...
              className={`text-sm font-bold tracking-wide transition-all hover:text-[#06B6D4] ${
                isActive("/organizer/dashboard") ? "text-[#06B6D4]" : "text-[#CBD5E1]/70"
              }`}
            >
              DASHBOARD
            </Link>
        ...
        <div className="flex items-center gap-6">
          {user?.email && (
            <div className="hidden lg:flex flex-col items-end">
              ...
              <span className="text-xs font-medium text-[#CBD5E1]/60">{user.email}</span>
            </div>
          )}
